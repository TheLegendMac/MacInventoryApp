...
public class ItemProvider extends ContentProvider {
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        if (id == -1) {
            Log.e(LOG_TAG, getContext().getString(R.string.failed_insert_row_message) + uri);
            return null;
        }
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                return updateItem(uri, contentValues, selection, selectionArgs);
            default:
                throw new IllegalArgumentException(getContext().getString(R.string.update_not_supported_message) + uri);
        }
    }
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link ItemContract.ItemEntry#COLUMN_ITEM_NAME} key is present,
        ...
        // If the {@link ItemContract.ItemEntry#COLUMN_ITEM_WEIGHT} key is present,
